    ...
    <footer className="footer">
      <div className="footer-content">
        <ul className="footer-links">
          <li><a href="#"><strong>Conócenos</strong></a></li>
          ...
          <ul className="footer-links footer-links-right">
            <li><a href="#"><strong>Gana Dinero con Nosotros</strong></a></li>
            <li><a href="#">Vender productos en Amazon</a></li>
            <li><a href="#">Vende en Amazon Business</a></li>
            <li><a href="#">Vender aplicaciones en Amazon</a></li>
